...
public class BookFlightWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnBookAFlight.setBackground(new java.awt.Color(0, 0, 0));
        btnBookAFlight.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        btnBookAFlight.setForeground(new java.awt.Color(255, 0, 0));
        ...
        comboBoxTime.setBackground(new java.awt.Color(0, 0, 0));
        comboBoxTime.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        comboBoxTime.setForeground(new java.awt.Color(255, 0, 0));
        comboBoxTime.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Morning", "Afternoon", "Evening ", "Night" }));

        tbltravelagency.setBackground(new java.awt.Color(0, 0, 0));
        tbltravelagency.setForeground(new java.awt.Color(255, 0, 0));
        ...
        btnSearchFlight.setBackground(new java.awt.Color(0, 0, 0));
        btnSearchFlight.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        btnSearchFlight.setForeground(new java.awt.Color(255, 0, 0));
        ...
        comboBoxDestination.setBackground(new java.awt.Color(0, 0, 0));
        comboBoxDestination.setForeground(new java.awt.Color(255, 0, 0));
        ...
        comboBoxSource.setBackground(new java.awt.Color(0, 0, 0));
        comboBoxSource.setForeground(new java.awt.Color(255, 0, 0));
