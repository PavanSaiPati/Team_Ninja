...
public class CustomersMngWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnBookFlights.setBackground(new java.awt.Color(0, 0, 0));
        btnBookFlights.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        btnBookFlights.setForeground(new java.awt.Color(255, 0, 0));
        ...
        btnViewPastBookings.setBackground(new java.awt.Color(0, 0, 0));
        btnViewPastBookings.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        btnViewPastBookings.setForeground(new java.awt.Color(255, 0, 0));
