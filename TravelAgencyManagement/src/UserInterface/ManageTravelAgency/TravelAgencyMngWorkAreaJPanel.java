...
public class TravelAgencyMngWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtSource.setBackground(new java.awt.Color(0, 0, 0));
        txtSource.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        txtSource.setForeground(new java.awt.Color(255, 0, 0));
        ...
        txtDestination.setBackground(new java.awt.Color(0, 0, 0));
        txtDestination.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        txtDestination.setForeground(new java.awt.Color(255, 0, 0));
        ...
        btnDeleteFlight.setBackground(new java.awt.Color(0, 0, 0));
        btnDeleteFlight.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        btnDeleteFlight.setForeground(new java.awt.Color(255, 0, 0));
        ...
        btnViewFlightDetails.setBackground(new java.awt.Color(0, 0, 0));
        btnViewFlightDetails.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        btnViewFlightDetails.setForeground(new java.awt.Color(255, 0, 0));
